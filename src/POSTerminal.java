		...
		while (userChoice == 1) {
			...
			while (correctType == false) { // user prompt to enter payment method
				...
				if (payType.equalsIgnoreCase("CASH")) {
					...
					// prints output to user to return the change
					...
					correctType = true;
					System.out.print("Enter credit card number: "); // prompts user to enter credit card number, then
					...
					System.out.print("Enter the expiration date: "); // prompts user to input expiration date
					...
					Payment p = new CreditCardPayment(); // new payment established
